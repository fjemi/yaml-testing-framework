...
CONFIG = '''
  environment:
    YAML_TESTING_FRAMEWORK_ROOT_DIR: ${YAML_TESTING_FRAMEWORK_ROOT_DIR}
    YAML_TESTING_FRAMEWORK_LOG_DIR: ${YAML_TESTING_FRAMEWORK_LOG_DIR}
    YAML_TESTING_FRAMEWORK_DEBUG: ${YAML_TESTING_FRAMEWORK_DEBUG}
    YAML_TESTING_FRAMEWORK_LOGGING_DISABLED: ${YAML_TESTING_FRAMEWORK_LOGGING_DISABLED}
  default_arguments:
    format: yaml
...
def get_log_file_location(
  ...
  directory = CONFIG.environment.YAML_TESTING_FRAMEWORK_LOG_DIR or f'{ROOT_DIR}/.logs'
